...
#define WPS_IO_MUX     PERIPHS_IO_MUX_GPIO5_U
#define WPS_IO_NUM     5
#define WPS_IO_FUNC    FUNC_GPIO5

#define RESET_IO_MUX     PERIPHS_IO_MUX_MTCK_U
#define RESET_IO_NUM     13
#define RESET_IO_FUNC    FUNC_GPIO13
